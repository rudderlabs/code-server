...
COPY rudderstack.svg .

# Copy logo to code-server static assets directory so it's accessible via /_static
USER root
COPY rudderstack.svg /usr/lib/code-server/src/browser/media/rudderstack.svg
USER codeuser
